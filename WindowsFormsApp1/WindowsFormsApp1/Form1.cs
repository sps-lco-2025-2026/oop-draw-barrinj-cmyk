...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Canvas_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                case "Line":
                    shapes.Add(new Line (currentPen, e.X, e.Y)); break;
                case "Rectangle":
                    shapes.Add(new Rectangle(currentPen, e.X, e.Y)); break;
                case "Ellipse":
                    shapes.Add(new Ellipse(currentPen, e.X, e.Y)); break;
                case "Circle":
                    shapes.Add(new Circle(currentPen, e.X, e.Y)); break;
            }
        }
